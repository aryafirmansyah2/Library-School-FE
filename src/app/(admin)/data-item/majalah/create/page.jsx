...
const formSchema = z.object({
  ...
  coverBuku: z.any().refine((file) => file instanceof File, {
    message: "Cover buku wajib diupload",
  }),
});

const CreateMajalahPage = () => {
    ...
    request
      ...
      .then(function (response) {
        ...
        if (response.status === 200 || response.status === 201) {
          ...
          setTimeout(() => {
            router.push("/data-item/majalah");
          }, 1000);
        } else {
          toast.dismiss();
          toast.error("Failed to created. Please try again.");
          setLoading(false);
        }
      })
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-8 bg-white w-full p-10 rounded-xl border border-gray-200">
        <div>
          <h1 className="text-3xl font-bold">Tambah Majalah</h1>
          <p className="mt-4">Ini halaman menambah majalah.</p>
        </div>
...
export default CreateMajalahPage;
