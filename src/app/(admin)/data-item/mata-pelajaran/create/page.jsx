  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-8 bg-white w-full p-10 rounded-xl border border-gray-200">
        <div>
          <h1 className="text-3xl font-bold">Tambah Buku Mata Pelajaran</h1>
          <p className="mt-4">Ini halaman menambah buku mata pelajaran.</p>
        </div>
